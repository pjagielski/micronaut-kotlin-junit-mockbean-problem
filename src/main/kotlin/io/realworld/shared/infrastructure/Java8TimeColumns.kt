...
class ZonedDateTimeColumnType : WrapperColumnType<DateTime, ZonedDateTime>(
    ...
    instanceCreator = DateTime::toZonedDateTime,
    valueExtractor = ZonedDateTime::toDateTime
)
...
class LocalDateTimeColumnType : WrapperColumnType<DateTime, LocalDateTime>(
    ...
    instanceCreator = DateTime::toJava8LocalDateTime,
    valueExtractor = LocalDateTime::toDateTime
)
